...
FROM customer_dim d
LEFT JOIN metrics m ON d.sk_customer = m.sk_customer
LEFT JOIN customer_demo_bridge fcd ON d.sk_customer = fcd.sk_customer
LEFT JOIN demographics_dim cdem ON fcd.sk_customer_demographic = cdem.sk_customer_demographic
